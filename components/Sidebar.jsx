...
const Sidebar = () => {
    const { isAuthenticated, nickname, setNickname, username, handleSetUsername } = useContext(AmazonContext);

    console.log("FROM CONTEXT!!!!", { isAuthenticated, nickname, setNickname, username, handleSetUsername })
